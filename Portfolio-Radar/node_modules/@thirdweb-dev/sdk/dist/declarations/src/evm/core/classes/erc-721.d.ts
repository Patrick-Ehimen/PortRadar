...
import type { NFT, NFTMetadata, NFTMetadataInput, NFTMetadataOrUri } from "../../../core/schema/nft";
...
export declare class Erc721<T extends Multiwrap | SignatureDrop | DropERC721 | TokenERC721 | BaseERC721 = BaseERC721> implements UpdateableNetwork, DetectableFeature {
     ...
     * @twfeature ERC721Supply | ERC721Enumerable
     */
    getAllOwners(queryParams?: QueryAllParams): Promise<{
        tokenId: number;
        owner: string;
    }[]>;
    /**
    ...
    update(tokenId: BigNumberish, metadata: NFTMetadataInput): Promise<Omit<{
        receipt: import("@ethersproject/abstract-provider").TransactionReceipt;
        data: () => Promise<unknown>;
    }, "data">>;
    /**
