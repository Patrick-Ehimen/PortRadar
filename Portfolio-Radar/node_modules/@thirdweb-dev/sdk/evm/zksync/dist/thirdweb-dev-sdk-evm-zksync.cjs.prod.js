...
require('../../../dist/contract-publisher-edd72687.cjs.prod.js');
require('@thirdweb-dev/contracts-js/dist/abis/ContractPublisher.json');
require('../../../dist/transactions-b50ec26f.cjs.prod.js');
...
require('../../../dist/fetchCurrencyValue-aa12871e.cjs.prod.js');
require('../../../dist/normalizePriceValue-446900e6.cjs.prod.js');
require('@thirdweb-dev/generated-abis');
require('../../../dist/deployContractDeterministic-83aad9e1.cjs.prod.js');
...
async function zkVerify(contractAddress, chainId, explorerAPIUrl, explorerAPIKey, storage, contractUri, encodedConstructorArgs) {
  try {
    ...
    if (contractBytecode === twProxyArtifactZK.bytecode) {
      ...
      invariant__default["default"](contractUri, "No contract URI provided");
      const rawMeta = await index.fetchRawPredeployMetadata(contractUri, storage);
      const metadataUri = rawMeta.compilers?.zksolc?.metadataUri;
      invariant__default["default"](metadataUri, "ZkSolc metadata not found");
