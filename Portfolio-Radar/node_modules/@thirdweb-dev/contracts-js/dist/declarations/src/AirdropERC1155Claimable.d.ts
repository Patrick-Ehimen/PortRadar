...
export interface AirdropERC1155ClaimableInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "airdropTokenAddress" | "availableAmount" | "claim" | "expirationTimestamp" | "initialize" | "isTrustedForwarder" | "merkleRoot" | "multicall" | "openClaimLimitPerWallet" | "supplyClaimedByWallet" | "tokenIds" | "tokenOwner" | "verifyClaim"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "openClaimLimitPerWallet", values: [BigNumberish]): string;
...
export interface AirdropERC1155Claimable extends BaseContract {
    ...
    functions: {
        ...
        initialize(_trustedForwarders: string[], _tokenOwner: string, _airdropTokenAddress: string, _tokenIds: BigNumberish[], _availableAmounts: BigNumberish[], _expirationTimestamp: BigNumberish, _openClaimLimitPerWallet: BigNumberish[], _merkleRoot: BytesLike[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        openClaimLimitPerWallet(arg0: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    callStatic: {
        ...
        expirationTimestamp(overrides?: CallOverrides): Promise<BigNumber>;
        initialize(_trustedForwarders: string[], _tokenOwner: string, _airdropTokenAddress: string, _tokenIds: BigNumberish[], _availableAmounts: BigNumberish[], _expirationTimestamp: BigNumberish, _openClaimLimitPerWallet: BigNumberish[], _merkleRoot: BytesLike[], overrides?: CallOverrides): Promise<void>;
        isTrustedForwarder(forwarder: string, overrides?: CallOverrides): Promise<boolean>;
        merkleRoot(arg0: BigNumberish, overrides?: CallOverrides): Promise<string>;
    ...
    populateTransaction: {
        ...
        openClaimLimitPerWallet(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
