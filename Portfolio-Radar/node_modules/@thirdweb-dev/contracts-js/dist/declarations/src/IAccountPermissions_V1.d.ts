...
export interface IAccountPermissions_V1Interface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "setPermissionsForSigner", values: [IAccountPermissions_V1.SignerPermissionRequestStruct, BytesLike]): string;
    encodeFunctionData(functionFragment: "verifySignerPermissionRequest", values: [IAccountPermissions_V1.SignerPermissionRequestStruct, BytesLike]): string;
...
export type SignerPermissionsUpdatedEvent = TypedEvent<[
    string,
    string,
    IAccountPermissions_V1.SignerPermissionRequestStructOutput
...
export interface IAccountPermissions_V1 extends BaseContract {
    ...
    functions: {
        ...
        setPermissionsForSigner(req: IAccountPermissions_V1.SignerPermissionRequestStruct, signature: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        verifySignerPermissionRequest(req: IAccountPermissions_V1.SignerPermissionRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<[boolean, string] & {
            success: boolean;
            signer: string;
        }>;
    };
    getAllActiveSigners(overrides?: CallOverrides): Promise<IAccountPermissions_V1.SignerPermissionsStructOutput[]>;
    getAllAdmins(overrides?: CallOverrides): Promise<string[]>;
    getAllSigners(overrides?: CallOverrides): Promise<IAccountPermissions_V1.SignerPermissionsStructOutput[]>;
    getPermissionsForSigner(signer: string, overrides?: CallOverrides): Promise<IAccountPermissions_V1.SignerPermissionsStructOutput>;
    isActiveSigner(signer: string, overrides?: CallOverrides): Promise<boolean>;
    isAdmin(signer: string, overrides?: CallOverrides): Promise<boolean>;
    setAdmin(account: string, isAdmin: boolean, overrides?: Overrides & {
        from?: string | Promise<string>;
    ...
    callStatic: {
        ...
        setPermissionsForSigner(req: IAccountPermissions_V1.SignerPermissionRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<void>;
        verifySignerPermissionRequest(req: IAccountPermissions_V1.SignerPermissionRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<[boolean, string] & {
            success: boolean;
            signer: string;
        }>;
    ...
    estimateGas: {
        ...
        verifySignerPermissionRequest(req: IAccountPermissions_V1.SignerPermissionRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        verifySignerPermissionRequest(req: IAccountPermissions_V1.SignerPermissionRequestStruct, signature: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
//# sourceMappingURL=IAccountPermissions_V1.d.ts.map