...
export interface IRulesEngineInterface extends utils.Interface {
    functions: {
...
export interface IRulesEngine extends BaseContract {
    ...
    functions: {
        ...
        deleteRule(ruleId: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        deleteRule(ruleId: BytesLike, overrides?: CallOverrides): Promise<void>;
        getAllRules(overrides?: CallOverrides): Promise<IRulesEngine.RuleWithIdStructOutput[]>;
        getRulesEngineOverride(overrides?: CallOverrides): Promise<string>;
        getScore(_tokenOwner: string, overrides?: CallOverrides): Promise<BigNumber>;
...
//# sourceMappingURL=IRulesEngine.d.ts.map