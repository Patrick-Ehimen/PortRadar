...
export declare namespace IERC721A {
    ...
    type TokenOwnershipStructOutput = [string, BigNumber, boolean] & {
        addr: string;
...
export interface ERC721SignatureMintInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "approve" | "balanceOf" | "batchFrozen" | "batchMintTo" | "burn" | "contractURI" | "explicitOwnershipOf" | "explicitOwnershipsOf" | "getApproved" | "getBaseURICount" | "getBatchIdAtIndex" | "getDefaultRoyaltyInfo" | "getRoyaltyInfoForToken" | "isApprovedForAll" | "isApprovedOrOwner" | "mintTo" | "mintWithSignature" | "multicall" | "name" | "nextTokenIdToMint" | "owner" | "ownerOf" | "primarySaleRecipient" | "royaltyInfo" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "setContractURI" | "setDefaultRoyaltyInfo" | "setOwner" | "setPrimarySaleRecipient" | "setRoyaltyInfoForToken" | "supportsInterface" | "symbol" | "tokenURI" | "tokensOfOwner" | "tokensOfOwnerIn" | "totalSupply" | "transferFrom" | "verify"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "explicitOwnershipsOf", values: [BigNumberish[]]): string;
...
export interface ERC721SignatureMint extends BaseContract {
    ...
    functions: {
        ...
        explicitOwnershipOf(tokenId: BigNumberish, overrides?: CallOverrides): Promise<[IERC721A.TokenOwnershipStructOutput]>;
        explicitOwnershipsOf(tokenIds: BigNumberish[], overrides?: CallOverrides): Promise<[IERC721A.TokenOwnershipStructOutput[]]>;
    ...
    estimateGas: {
        ...
        explicitOwnershipsOf(tokenIds: BigNumberish[], overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        explicitOwnershipsOf(tokenIds: BigNumberish[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
