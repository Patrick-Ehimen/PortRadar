...
export interface IAccountFactory extends BaseContract {
    ...
    functions: {
        ...
        onSignerAdded(signer: string, salt: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        onSignerRemoved(signer: string, salt: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    };
    accountImplementation(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        getAddress(adminSigner: string, data: BytesLike, overrides?: CallOverrides): Promise<string>;
        getAllAccounts(overrides?: CallOverrides): Promise<string[]>;
        onSignerAdded(signer: string, salt: BytesLike, overrides?: CallOverrides): Promise<void>;
        onSignerRemoved(signer: string, salt: BytesLike, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
