...
import { Color as Color$1, FunnelVariantType as FunnelVariantType$1, Size as Size$2, DeltaType as DeltaType$1, HorizontalPosition as HorizontalPosition$1, VerticalPosition as VerticalPosition$1, ValueFormatter as ValueFormatter$1 } from 'lib';
...
interface FunnelChartProps extends React$1.HTMLAttributes<HTMLDivElement> {
    data: DataT[];
    ...
    showTooltip?: boolean;
    onValueChange?: (value: EventProps) => void;
    customTooltip?: React$1.ComponentType<CustomTooltipProps>;
    noDataText?: string;
    rotateLabelX?: {
        angle: number;
        verticalShift?: number;
...
declare const TableHeaderCell: React$1.ForwardRefExoticComponent<React$1.ThHTMLAttributes<HTMLTableCellElement> & React$1.RefAttributes<HTMLTableCellElement>>;
