...
// node_modules/@thirdweb-dev/sdk/dist/marketplace-db5a9e89.browser.esm.js
...
var MarketplaceDirect = class {
  ...
  async isStillValidListing(listing, quantity) {
    ...
    const ERC165Abi = (await import("./IERC165-BU7CSJC2.js")).default;
    const erc165 = new Contract(listing.assetContractAddress, ERC165Abi, provider);
    const isERC721 = await erc165.supportsInterface(InterfaceId_IERC721);
    const isERC1155 = await erc165.supportsInterface(InterfaceId_IERC1155);
    if (isERC721) {
      const ERC721Abi = (await import("./IERC721-NAOI3XFC.js")).default;
      ...
      const ERC1155Abi = (await import("./IERC1155-GMURUCQF.js")).default;
...
//# sourceMappingURL=marketplace-db5a9e89.browser.esm-GUBP3XPR.js.map
