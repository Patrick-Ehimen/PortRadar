...
var CoinbaseWalletConnector = class extends WagmiConnector {
  ...
  async getProvider() {
    var _a;
    if (!this._provider) {
      let CoinbaseWalletSDK = (await import("./dist-2XE5OEZP.js")).default;
...
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-4EEKSWQR.js.map
