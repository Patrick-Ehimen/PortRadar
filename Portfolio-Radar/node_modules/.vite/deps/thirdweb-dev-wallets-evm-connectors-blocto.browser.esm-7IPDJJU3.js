...
} from "./chunk-I3DP2MPF.js";
import {
  getValidPublicRPCUrl
} from "./chunk-BCO5OQ62.js";
import {
  WagmiConnector
} from "./chunk-RCCBID5F.js";
import {
  _defineProperty
...
var import_dist, import_dist2, import_dist3, U32_MASK64, _32n, toBig, shrSH, shrSL, rotrSH, rotrSL, rotrBH, rotrBL, rotr32H, rotr32L, rotlSH, rotlSL, rotlBH, rotlBL, add3L, add3H, add4L, add4H, add5L, add5H, u64, u64_default;
var init_u64 = __esm({
  "node_modules/@noble/hashes/esm/_u64.js"() {
...
var import_dist4, import_dist5, import_dist6, SHA512_Kh, SHA512_Kl, SHA512_W_H, SHA512_W_L, SHA512, SHA512_224, SHA512_256, SHA384, sha512, sha512_224, sha512_256, sha384;
...
var import_dist7, import_dist8, import_dist9, _0n, _1n, _2n, hexes, asciis, bitMask, u8n, u8fr, validatorFns;
...
var import_dist10, import_dist11, import_dist12, _0n2, _1n2, _2n2, _3n, _4n, _5n, _8n, _9n, _16n, isNegativeLE, FIELD_FIELDS;
...
var import_dist13, import_dist14, import_dist15, _0n3, _1n3;
...
var import_dist16, import_dist17, import_dist18, _0n4, _1n4, _2n3, _8n2, VERIFY_DEFAULT;
...
var import_dist19, import_dist20, import_dist21, _0n5, _1n5;
...
var import_dist28, import_dist29, import_dist30, end_of_stream, finished, DEFAULT_ENCODING;
...
var import_dist79, import_dist80, import_dist81, SHA3_PI, SHA3_ROTL, _SHA3_IOTA, _0n7, _1n7, _2n5, _7n, _256n, _0x71n, SHA3_IOTA_H, SHA3_IOTA_L, rotlH, rotlL, Keccak, gen, sha3_224, sha3_256, sha3_384, sha3_512, keccak_224, keccak_256, keccak_384, keccak_512, genShake, shake128, shake256;
var init_sha3 = __esm({
  "node_modules/@noble/hashes/esm/sha3.js"() {
...
var import_dist82, import_dist83, import_dist84, b2n, h2b, DER, _0n8, _1n8, _2n6, _3n2, _4n2;
...
var import_dist85, import_dist86, import_dist87, HMAC, hmac;
var init_hmac = __esm({
  "node_modules/@noble/hashes/esm/hmac.js"() {
...
var import_dist91, import_dist92, import_dist93, secp256k1P, secp256k1N, _1n9, _2n7, divNearest, Fp2, secp256k1, _0n9, fe, ge, TAGGED_HASH_PREFIXES, pointToBytes, numTo32b, modP, modN, Point, GmulAdd, schnorr, isoMap, mapSWU, htf2, hashToCurve2, encodeToCurve2;
...
var init_index_browser_esm = __esm({
  "node_modules/@solana/web3.js/lib/index.browser.esm.js"() {
    ...
    toBuffer = (arr2) => {
      if (Buffer$1.isBuffer(arr2)) {
        return arr2;
      } else if (arr2 instanceof Uint8Array) {
        return Buffer$1.from(arr2.buffer, arr2.byteOffset, arr2.byteLength);
      } else {
        return Buffer$1.from(arr2);
      }
    };
    Struct2 = class {
    ...
    Message = class _Message {
      ...
      static from(buffer) {
        ...
        for (let i = 0; i < instructionCount; i++) {
          ...
          const accounts = byteArray.splice(0, accountCount2);
...
Missing signature for public key${sigErrors.missing.length === 1 ? "" : "(s)"} [\`${sigErrors.missing.map((p) => p.toBase58()).join("`, `")}\`].`;
      ...
      static from(buffer) {
        ...
        for (let i = 0; i < signatureCount; i++) {
          const signature2 = byteArray.splice(0, SIGNATURE_LENGTH_IN_BYTES);
    ...
    bigInt = (length) => (property) => {
      ...
      bigIntLayout.decode = (buffer, offset2) => {
        ...
        return (0, import_bigint_buffer.toBigIntLE)(Buffer$1.from(src2));
      };
    ...
    ValidatorInfo = class _ValidatorInfo {
      ...
      static fromConfigData(buffer) {
        ...
        const configKeys = [];
        for (let i = 0; i < 2; i++) {
          const publicKey2 = new PublicKey(byteArray.splice(0, PUBLIC_KEY_LENGTH));
...
@blocto/sdk/dist/blocto-sdk.module.js:
   ...
   *)
*/
//# sourceMappingURL=thirdweb-dev-wallets-evm-connectors-blocto.browser.esm-7IPDJJU3.js.map
