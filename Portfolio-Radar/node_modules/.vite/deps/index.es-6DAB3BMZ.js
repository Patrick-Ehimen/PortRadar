...
(function(A, u2) {
  (function() {
    ...
    var Cf = function h(g2) {
      ...
      }(), Rf = g2.clearTimeout !== k2.clearTimeout && g2.clearTimeout, bf = C && C.now !== k2.Date.now && C.now, Tf = g2.setTimeout !== k2.setTimeout && g2.setTimeout, Ue = X.ceil, We = X.floor, Gr = M2.getOwnPropertySymbols, Lf = Le ? Le.isBuffer : i, $s = g2.isFinite, Df = Oe.join, Hf = Rs(M2.keys, M2), Q2 = X.max, nn = X.min, Nf = C.now, $f = g2.parseInt, Us = X.random, Uf = Oe.reverse, zr = mt(g2, "DataView"), te = mt(g2, "Map"), Kr = mt(g2, "Promise"), $t = mt(g2, "Set"), ee = mt(g2, "WeakMap"), re = mt(M2, "create"), Fe = ee && new ee(), Ut = {}, Wf = wt(zr), Ff = wt(te), Mf = wt(Kr), qf = wt($t), Bf = wt(ee), Me = et ? et.prototype : i, ie = Me ? Me.valueOf : i, Ws = Me ? Me.toString : i;
      function a(n) {
      ...
      function Dc(n, t, e, r, s, o, f2) {
        ...
        if (m2) {
          ...
          _2 = l, P2 || I || E2 ? O2(c) ? _2 = c : Z(c) ? _2 = un(c) : I ? (m2 = false, _2 = hu(l, true)) : E2 ? (m2 = false, _2 = lu(l, true)) : _2 = [] : pe(l) || Pt(l) ? (_2 = c, Pt(c) ? _2 = oa(c) : (!K2(c) || Jn(c)) && (_2 = bu(l))) : m2 = false;
        }
      ...
      function $c(n, t, e, r) {
        for (var s = -1, o = Q2(Ue((t - n) / (e || 1)), 0), f2 = p2(o); o--; )
          f2[r ? o : ++s] = n, n += e;
        return f2;
      }
      function ri(n, t) {
      ...
      function fe(n, t, e, r) {
        ...
        for (var s = -1, o = t.length, f2 = o - 1, c = n; c != null && ++s < o; ) {
          ...
          if (s != f2) {
            var _2 = c[l];
            v2 = r ? r(_2, l, c) : i, v2 === i && (v2 = K2(_2) ? _2 : Zn(t[s + 1]) ? [] : {});
          }
          se(c, l, v2), c = c[l];
        }
        return n;
      ...
      function du(n, t, e, r) {
        for (var s = -1, o = n.length, f2 = e.length, c = -1, l = t.length, v2 = Q2(o - f2, 0), _2 = p2(l + v2), m2 = !r; ++c < l; )
          _2[c] = t[c];
        for (; ++s < f2; )
          (m2 || s < o) && (_2[e[s]] = n[s]);
        for (; v2--; )
      ...
      function gu(n, t, e, r) {
        for (var s = -1, o = n.length, f2 = -1, c = e.length, l = -1, v2 = t.length, _2 = Q2(o - c, 0), m2 = p2(_2 + v2), P2 = !r; ++s < _2; )
          m2[s] = n[s];
        for (var I = s; ++l < v2; )
          m2[I + l] = t[l];
        for (; ++f2 < c; )
      ...
      function Kn(n, t, e, r, s, o, f2, c) {
        ...
        if (!l && typeof n != "function")
          throw new wn(D2);
        var v2 = r ? r.length : 0;
        if (v2 || (t &= ~(Hn | St), r = s = i), f2 = f2 === i ? f2 : Q2(R(f2), 0), c = c === i ? c : R(c), v2 -= s ? s.length : 0, t & St) {
          var _2 = r, m2 = s;
          r = s = i;
        }
        var P2 = l ? i : di(n), I = [n, t, e, r, s, _2, m2, o, f2, c];
        if (P2 && ph(I, P2), n = I[0], t = I[1], e = I[2], r = I[3], s = I[4], c = I[9] = I[9] === i ? l ? 0 : n.length : Q2(I[9] - v2, 0), !c && t & (Dn | yt) && (t &= ~(Dn | yt)), !t || t == vn)
          var E2 = Xc(n, t, e);
        else
...
`);
      ...
      function Du(n, t, e) {
        return t = Q2(t === i ? n.length - 1 : t, 0), function() {
          for (var r = arguments, s = -1, o = Q2(r.length - t, 0), f2 = p2(o); ++s < o; )
            f2[s] = r[t + s];
          s = -1;
      ...
      var Nu = Uu(iu), le2 = Tf || function(n, t) {
      ...
      function Mu(n, t, e) {
        ...
        if (!r)
          return -1;
        var s = e == null ? 0 : R(e);
        return s < 0 && (s = Q2(r + s, 0)), ye(n, x(t, 3), s);
      }
      function qu(n, t, e) {
        var r = n == null ? 0 : n.length;
        if (!r)
          return -1;
        var s = r - 1;
        return e !== i && (s = R(e), s = e < 0 ? Q2(r + s, 0) : nn(s, r - 1)), ye(n, x(t, 3), s, true);
      }
      function Bu(n) {
      ...
      function Wh(n, t, e) {
        ...
        if (!r)
          return -1;
        var s = r;
        return e !== i && (s = R(e), s = s < 0 ? Q2(r + s, 0) : nn(s, r - 1)), t === t ? _f(n, t, s) : ye(n, Is, s, true);
      }
      function Fh(n, t) {
      ...
      function na(n, t, e) {
        ...
        if (typeof n != "function")
          throw new wn(D2);
        t = xn(t) || 0, K2(e) && (_2 = !!e.leading, m2 = "maxWait" in e, o = m2 ? Q2(xn(e.maxWait) || 0, t) : o, P2 = "trailing" in e ? !!e.trailing : P2);
        function I(J) {
          var Tn = r, Qn = s;
          return r = s = i, v2 = J, f2 = n.apply(Qn, Tn), f2;
        }
        function E2(J) {
          return v2 = J, c = le2(H, t), _2 ? I(J) : f2;
        }
        function b2(J) {
        ...
        function gn() {
          ...
          if (r = arguments, s = this, l = J, Tn) {
            if (c === i)
              return E2(l);
            if (m2)
              return cu(c), c = le2(H, t), I(l);
          }
          return c === i && (c = le2(H, t)), f2;
        }
      ...
      function hd(n, t, e) {
        ...
        if (t = x(t, 4), e == null) {
          ...
          s ? e = r ? new o() : [] : K2(n) ? e = Jn(o) ? Wt(He(n)) : {} : e = {};
        }
...
`) + m2 + `return __p
      ...
      function Li(n, t, e) {
        var r = V(t), s = ze(t, r);
        e == null && !(K2(t) && (s.length || !r.length)) && (e = t, t = n, n = this, s = ze(t, V(t)));
        var o = !(K2(e) && "chain" in e) || !!e.chain, f2 = Jn(n);
...
var v = class _v {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? g(this.rpc.chains) : g(this.rpc.optionalChains), this.signer = await hv.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storageOptions: t.storageOptions }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s;
      try {
        const { WalletConnectModal: i } = await import("./dist-XJJGWLY7.js");
        s = i;
      } catch {
...
@walletconnect/universal-provider/dist/index.es.js:
  ...
  *)
*/
//# sourceMappingURL=index.es-6DAB3BMZ.js.map
