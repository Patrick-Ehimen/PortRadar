...
import {
  require_immutable
} from "./chunk-UIPDUAVW.js";
import {
  require_semver
} from "./chunk-DOUUB5WK.js";
import "./chunk-JV2CNAH2.js";
import {
  require_js
} from "./chunk-BIURNFLG.js";
import {
  require_callBound,
  require_get_intrinsic,
  require_sha,
  require_type
} from "./chunk-MMCJUWWB.js";
import {
  require_events
...
var import_dist4, import_dist5, import_dist6, extendStatics, __assign, __createBinding, __setModuleDefault, _SuppressedError, tslib_es6_default;
...
function x() {
  ...
  for (i.sort(f); n2 = i.shift(); )
    n2.__d && (u3 = i.length, o3 = void 0, e3 = (r4 = (t3 = n2).__v).__e, s3 = [], a3 = [], (c3 = t3.__P) && ((o3 = v({}, r4)).__v = r4.__v + 1, l.vnode && l.vnode(o3), L(c3, o3, r4, t3.__n, void 0 !== c3.ownerSVGElement, 32 & r4.__u ? [e3] : null, s3, null == e3 ? m(r4) : e3, !!(32 & r4.__u), a3), o3.__v = r4.__v, o3.__.__k[o3.__i] = o3, M(s3, o3, a3), o3.__e != e3 && w(o3)), i.length > u3 && i.sort(f));
  x.__r = 0;
}
...
function T(n2, l3, u3, t3, i3) {
  ...
  n:
    if ("style" === l3)
      ...
      o3 = l3 !== (l3 = l3.replace(/(PointerCapture)$|Capture$/i, "$1")), l3 = l3.toLowerCase() in n2 ? l3.toLowerCase().slice(2) : l3.slice(2), n2.l || (n2.l = {}), n2.l[l3 + o3] = u3, u3 ? t3 ? u3.u = t3.u : (u3.u = Date.now(), n2.addEventListener(l3, o3 ? D : A, o3)) : n2.removeEventListener(l3, o3 ? D : A, o3);
    else {
      if (i3)
...
function L(n2, u3, t3, i3, o3, r4, f3, e3, c3, s3) {
  var a3, p3, y3, d3, _3, m3, w3, k3, x3, P3, S2, $2, H2, I2, T3, A3 = u3.type;
    ...
    if ("function" == typeof A3)
      try {
        if (k3 = u3.props, x3 = (a3 = A3.contextType) && i3[a3.__c], P3 = a3 ? x3 ? x3.props.value : a3.__ : i3, t3.__c ? w3 = (p3 = u3.__c = t3.__c).__ = p3.__E : ("prototype" in A3 && A3.prototype.render ? u3.__c = p3 = new A3(k3, P3) : (u3.__c = p3 = new b(k3, P3), p3.constructor = A3, p3.render = O), x3 && x3.sub(p3), p3.props = k3, p3.state || (p3.state = {}), p3.context = P3, p3.__n = i3, y3 = p3.__d = true, p3.__h = [], p3._sb = []), null == p3.__s && (p3.__s = p3.state), null != A3.getDerivedStateFromProps && (p3.__s == p3.state && (p3.__s = v({}, p3.__s)), v(p3.__s, A3.getDerivedStateFromProps(k3, p3.__s))), d3 = p3.props, _3 = p3.state, p3.__v = u3, y3)
          ...
          if (null == A3.getDerivedStateFromProps && k3 !== d3 && null != p3.componentWillReceiveProps && p3.componentWillReceiveProps(k3, P3), !p3.__e && (null != p3.shouldComponentUpdate && false === p3.shouldComponentUpdate(k3, p3.__s, P3) || u3.__v === t3.__v)) {
        ...
        if (p3.context = P3, p3.props = k3, p3.__P = n2, p3.__e = false, $2 = l.__r, H2 = 0, "prototype" in A3 && A3.prototype.render) {
        ...
        p3.state = p3.__s, null != p3.getChildContext && (i3 = v(v({}, i3), p3.getChildContext())), y3 || null == p3.getSnapshotBeforeUpdate || (m3 = p3.getSnapshotBeforeUpdate(d3, _3)), C(n2, h(T3 = null != a3 && a3.type === g && null == a3.key ? a3.props.children : a3) ? T3 : [T3], u3, t3, i3, o3, r4, f3, e3, c3, s3), p3.base = u3.__e, u3.__u &= -161, p3.__h.length && f3.push(p3), w3 && (p3.__E = p3.__ = null);
      } catch (n3) {
...
function j(l3, u3, t3, i3, o3, r4, f3, e3, s3) {
  ...
  if (null === x3)
    ...
    for (a3 in w3)
      _3 = w3[a3], "children" == a3 || ("dangerouslySetInnerHTML" == a3 ? y3 = _3 : "key" === a3 || a3 in k3 || T(l3, a3, null, _3, o3));
    for (a3 in k3)
      _3 = k3[a3], "children" == a3 ? d3 = _3 : "dangerouslySetInnerHTML" == a3 ? v3 = _3 : "value" == a3 ? g3 = _3 : "checked" == a3 ? b3 = _3 : "key" === a3 || e3 && "function" != typeof _3 || w3[a3] === _3 || T(l3, a3, _3, w3[a3], o3);
    if (v3)
      ...
      for (a3 = r4.length; a3--; )
        null != r4[a3] && p(r4[a3]);
    e3 || (a3 = "value", void 0 !== g3 && (g3 !== l3[a3] || "progress" === x3 && !g3 || "option" === x3 && g3 !== w3[a3]) && T(l3, a3, g3, w3[a3], false), a3 = "checked", void 0 !== b3 && b3 !== l3[a3] && T(l3, a3, b3, w3[a3], false));
  }
  return l3;
}
function z(n2, u3, t3) {
...
var import_dist7, import_dist8, import_dist9, n, l, u, t, i, o, r, f, e, c, s, a, h;
var init_preact_module = __esm({
  "node_modules/preact/dist/preact.module.js"() {
    ...
    n = s.slice, l = { __e: function(n2, l3, u3, t3) {
      ...
      var u3;
      u3 = null != this.__s && this.__s !== this.state ? this.__s : this.__s = v({}, this.state), "function" == typeof n2 && (n2 = n2(v({}, u3), this.props)), n2 && v(u3, n2), null != n2 && this.__v && (l3 && this._sb.push(l3), k(this));
...
var import_dist13, import_dist14, import_dist15, _enable_super_gross_mode_that_will_cause_bad_things, config;
...
var import_dist19, import_dist20, import_dist21, empty2;
...
var import_dist22, import_dist23, import_dist24, isArray;
...
var import_dist28, import_dist29, import_dist30, UnsubscriptionErrorImpl, UnsubscriptionError;
...
var import_dist31, import_dist32, import_dist33, Subscription;
...
var import_dist34, import_dist35, import_dist36, rxSubscriber;
...
var import_dist37, import_dist38, import_dist39, Subscriber, SafeSubscriber;
...
var import_dist46, import_dist47, import_dist48, observable;
...
var import_dist55, import_dist56, import_dist57, Observable;
var init_Observable = __esm({
  "node_modules/rxjs/_esm5/internal/Observable.js"() {
...
var import_dist58, import_dist59, import_dist60, ObjectUnsubscribedErrorImpl, ObjectUnsubscribedError;
...
var import_dist61, import_dist62, import_dist63, SubjectSubscription;
...
var import_dist64, import_dist65, import_dist66, SubjectSubscriber, Subject, AnonymousSubject;
...
var import_dist67, import_dist68, import_dist69, RefCountOperator, RefCountSubscriber;
...
var import_dist70, import_dist71, import_dist72, ConnectableObservable, connectableObservableDescriptor, ConnectableSubscriber, RefCountOperator2, RefCountSubscriber2;
...
var import_dist73, import_dist74, import_dist75, GroupByOperator, GroupBySubscriber, GroupDurationSubscriber, GroupedObservable, InnerRefCountSubscription;
...
var import_dist76, import_dist77, import_dist78, BehaviorSubject;
...
var import_dist79, import_dist80, import_dist81, Action;
...
var import_dist82, import_dist83, import_dist84, AsyncAction;
...
var import_dist85, import_dist86, import_dist87, QueueAction;
...
var import_dist88, import_dist89, import_dist90, Scheduler;
...
var import_dist91, import_dist92, import_dist93, AsyncScheduler;
...
var import_dist94, import_dist95, import_dist96, QueueScheduler;
...
var import_dist97, import_dist98, import_dist99, queueScheduler, queue;
...
var import_dist100, import_dist101, import_dist102, EMPTY;
...
var import_dist106, import_dist107, import_dist108, subscribeToArray;
...
var import_dist121, import_dist122, import_dist123, NotificationKind, Notification;
...
var import_dist124, import_dist125, import_dist126, ObserveOnOperator, ObserveOnSubscriber, ObserveOnMessage;
...
var import_dist127, import_dist128, import_dist129, ReplaySubject, ReplayEvent;
...
var import_dist130, import_dist131, import_dist132, AsyncSubject;
...
var import_dist133, import_dist134, import_dist135, nextHandle, RESOLVED, activeHandles, Immediate;
...
var import_dist136, import_dist137, import_dist138, AsapAction;
...
var import_dist139, import_dist140, import_dist141, AsapScheduler;
...
var import_dist142, import_dist143, import_dist144, asapScheduler, asap;
var init_asap = __esm({
  "node_modules/rxjs/_esm5/internal/scheduler/asap.js"() {
...
var import_dist145, import_dist146, import_dist147, asyncScheduler, async;
...
var import_dist148, import_dist149, import_dist150, AnimationFrameAction;
...
var import_dist151, import_dist152, import_dist153, AnimationFrameScheduler;
...
var import_dist154, import_dist155, import_dist156, animationFrameScheduler, animationFrame;
...
var import_dist157, import_dist158, import_dist159, VirtualTimeScheduler, VirtualAction;
...
var import_dist166, import_dist167, import_dist168, ArgumentOutOfRangeErrorImpl, ArgumentOutOfRangeError;
...
var import_dist169, import_dist170, import_dist171, EmptyErrorImpl, EmptyError;
...
var import_dist172, import_dist173, import_dist174, TimeoutErrorImpl, TimeoutError;
...
var import_dist175, import_dist176, import_dist177, MapOperator, MapSubscriber;
var init_map = __esm({
  "node_modules/rxjs/_esm5/internal/operators/map.js"() {
...
var import_dist184, import_dist185, import_dist186, OuterSubscriber;
...
var import_dist187, import_dist188, import_dist189, InnerSubscriber;
...
var import_dist190, import_dist191, import_dist192, subscribeToPromise;
...
var import_dist193, import_dist194, import_dist195, iterator;
...
var import_dist196, import_dist197, import_dist198, subscribeToIterable;
...
var import_dist199, import_dist200, import_dist201, subscribeToObservable;
...
var import_dist202, import_dist203, import_dist204, isArrayLike;
...
var import_dist208, import_dist209, import_dist210, subscribeTo;
...
var import_dist214, import_dist215, import_dist216, NONE, CombineLatestOperator, CombineLatestSubscriber;
...
var import_dist238, import_dist239, import_dist240, SimpleInnerSubscriber, ComplexInnerSubscriber, SimpleOuterSubscriber, ComplexOuterSubscriber;
...
var import_dist241, import_dist242, import_dist243, MergeMapOperator, MergeMapSubscriber, flatMap;
...
var import_dist280, import_dist281, import_dist282, NEVER;
...
var import_dist292, import_dist293, import_dist294, FilterOperator, FilterSubscriber;
...
var import_dist298, import_dist299, import_dist300, RaceOperator, RaceSubscriber;
var init_race = __esm({
  "node_modules/rxjs/_esm5/internal/observable/race.js"() {
...
var import_dist310, import_dist311, import_dist312, ZipOperator, ZipSubscriber, StaticIterator, StaticArrayIterator, ZipBufferIterator;
var init_zip = __esm({
  "node_modules/rxjs/_esm5/internal/observable/zip.js"() {
...
var import_dist316, import_dist317, import_dist318, clsx_m_default;
...
var import_dist319, import_dist320, import_dist321, t2, r3, u2, i2, o2, f2, c2, e2, a2, v2, l2, m2, s2, d2, k2;
...
var require_ConnectContent = __commonJS({
  "node_modules/@coinbase/wallet-sdk/dist/components/ConnectContent/ConnectContent.js"(exports) {
    ...
    var coinbase_round_svg_1 = __importDefault2(require_coinbase_round_svg());
    var coinbase_wallet_round_svg_1 = __importDefault2(require_coinbase_wallet_round_svg());
    var QRCodeIcon_1 = require_QRCodeIcon();
    var QRLogoCoinbase_1 = __importDefault2(require_QRLogoCoinbase());
    var QRLogoWallet_1 = __importDefault2(require_QRLogoWallet());
...
var import_dist322, import_dist323, import_dist324, AuditOperator, AuditSubscriber;
...
var import_dist328, import_dist329, import_dist330, BufferOperator, BufferSubscriber;
...
var import_dist331, import_dist332, import_dist333, BufferCountOperator, BufferCountSubscriber, BufferSkipCountSubscriber;
...
var import_dist334, import_dist335, import_dist336, BufferTimeOperator, Context, BufferTimeSubscriber;
...
var import_dist337, import_dist338, import_dist339, BufferToggleOperator, BufferToggleSubscriber;
...
var import_dist340, import_dist341, import_dist342, BufferWhenOperator, BufferWhenSubscriber;
...
var import_dist343, import_dist344, import_dist345, CatchOperator, CatchSubscriber;
...
var import_dist361, import_dist362, import_dist363, CountOperator, CountSubscriber;
...
var import_dist364, import_dist365, import_dist366, DebounceOperator, DebounceSubscriber;
...
var import_dist367, import_dist368, import_dist369, DebounceTimeOperator, DebounceTimeSubscriber;
...
var import_dist370, import_dist371, import_dist372, DefaultIfEmptyOperator, DefaultIfEmptySubscriber;
...
var import_dist376, import_dist377, import_dist378, DelayOperator, DelaySubscriber, DelayMessage;
...
var import_dist379, import_dist380, import_dist381, DelayWhenOperator, DelayWhenSubscriber, SubscriptionDelayObservable, SubscriptionDelaySubscriber;
...
var import_dist382, import_dist383, import_dist384, DeMaterializeOperator, DeMaterializeSubscriber;
...
var import_dist385, import_dist386, import_dist387, DistinctOperator, DistinctSubscriber;
...
var import_dist388, import_dist389, import_dist390, DistinctUntilChangedOperator, DistinctUntilChangedSubscriber;
...
var import_dist394, import_dist395, import_dist396, ThrowIfEmptyOperator, ThrowIfEmptySubscriber;
...
var import_dist397, import_dist398, import_dist399, TakeOperator, TakeSubscriber;
var init_take = __esm({
  "node_modules/rxjs/_esm5/internal/operators/take.js"() {
...
var import_dist406, import_dist407, import_dist408, EveryOperator, EverySubscriber;
...
var import_dist409, import_dist410, import_dist411, SwitchFirstOperator, SwitchFirstSubscriber;
...
var import_dist412, import_dist413, import_dist414, ExhaustMapOperator, ExhaustMapSubscriber;
...
var import_dist415, import_dist416, import_dist417, ExpandOperator, ExpandSubscriber;
...
var import_dist418, import_dist419, import_dist420, FinallyOperator, FinallySubscriber;
...
var import_dist421, import_dist422, import_dist423, FindValueOperator, FindValueSubscriber;
var init_find = __esm({
  "node_modules/rxjs/_esm5/internal/operators/find.js"() {
...
var import_dist424, import_dist425, import_dist426;
...
var import_dist430, import_dist431, import_dist432, IgnoreElementsOperator, IgnoreElementsSubscriber;
...
var import_dist433, import_dist434, import_dist435, IsEmptyOperator, IsEmptySubscriber;
...
var import_dist436, import_dist437, import_dist438, TakeLastOperator, TakeLastSubscriber;
...
var import_dist442, import_dist443, import_dist444, MapToOperator, MapToSubscriber;
...
var import_dist445, import_dist446, import_dist447, MaterializeOperator, MaterializeSubscriber;
...
var import_dist448, import_dist449, import_dist450, ScanOperator, ScanSubscriber;
var init_scan = __esm({
  "node_modules/rxjs/_esm5/internal/operators/scan.js"() {
...
var import_dist457, import_dist458, import_dist459;
...
var import_dist460, import_dist461, import_dist462;
...
var import_dist463, import_dist464, import_dist465, MergeScanOperator, MergeScanSubscriber;
...
var import_dist469, import_dist470, import_dist471, MulticastOperator;
...
var import_dist472, import_dist473, import_dist474, OnErrorResumeNextOperator, OnErrorResumeNextSubscriber;
...
var import_dist475, import_dist476, import_dist477, PairwiseOperator, PairwiseSubscriber;
...
var import_dist478, import_dist479, import_dist480;
...
var import_dist484, import_dist485, import_dist486;
...
var import_dist490, import_dist491, import_dist492;
...
var import_dist499, import_dist500, import_dist501, RepeatOperator, RepeatSubscriber;
...
var import_dist502, import_dist503, import_dist504, RepeatWhenOperator, RepeatWhenSubscriber;
...
var import_dist505, import_dist506, import_dist507, RetryOperator, RetrySubscriber;
...
var import_dist508, import_dist509, import_dist510, RetryWhenOperator, RetryWhenSubscriber;
...
var import_dist511, import_dist512, import_dist513, SampleOperator, SampleSubscriber;
...
var import_dist514, import_dist515, import_dist516, SampleTimeOperator, SampleTimeSubscriber;
...
var import_dist517, import_dist518, import_dist519, SequenceEqualOperator, SequenceEqualSubscriber, SequenceEqualCompareToSubscriber;
...
var import_dist520, import_dist521, import_dist522;
...
var import_dist526, import_dist527, import_dist528, SingleOperator, SingleSubscriber;
...
var import_dist529, import_dist530, import_dist531, SkipOperator, SkipSubscriber;
var init_skip = __esm({
  "node_modules/rxjs/_esm5/internal/operators/skip.js"() {
...
var import_dist532, import_dist533, import_dist534, SkipLastOperator, SkipLastSubscriber;
...
var import_dist535, import_dist536, import_dist537, SkipUntilOperator, SkipUntilSubscriber;
...
var import_dist538, import_dist539, import_dist540, SkipWhileOperator, SkipWhileSubscriber;
...
var import_dist544, import_dist545, import_dist546, SubscribeOnObservable;
...
var import_dist547, import_dist548, import_dist549, SubscribeOnOperator;
...
var import_dist550, import_dist551, import_dist552, SwitchMapOperator, SwitchMapSubscriber;
...
var import_dist559, import_dist560, import_dist561, TakeUntilOperator, TakeUntilSubscriber;
...
var import_dist562, import_dist563, import_dist564, TakeWhileOperator, TakeWhileSubscriber;
...
var import_dist565, import_dist566, import_dist567, DoOperator, TapSubscriber;
var init_tap = __esm({
  "node_modules/rxjs/_esm5/internal/operators/tap.js"() {
...
var import_dist568, import_dist569, import_dist570, defaultThrottleConfig, ThrottleOperator, ThrottleSubscriber;
...
var import_dist571, import_dist572, import_dist573, ThrottleTimeOperator, ThrottleTimeSubscriber;
...
var import_dist574, import_dist575, import_dist576, TimeInterval;
...
var import_dist577, import_dist578, import_dist579, TimeoutWithOperator, TimeoutWithSubscriber;
...
var import_dist580, import_dist581, import_dist582;
...
var import_dist583, import_dist584, import_dist585, Timestamp;
...
var import_dist586, import_dist587, import_dist588;
...
var import_dist589, import_dist590, import_dist591, WindowOperator, WindowSubscriber;
...
var import_dist592, import_dist593, import_dist594, WindowCountOperator, WindowCountSubscriber;
...
var import_dist595, import_dist596, import_dist597, WindowTimeOperator, CountedSubject, WindowTimeSubscriber;
...
var import_dist598, import_dist599, import_dist600, WindowToggleOperator, WindowToggleSubscriber;
...
var import_dist601, import_dist602, import_dist603, WindowOperator2, WindowSubscriber2;
...
var import_dist604, import_dist605, import_dist606, WithLatestFromOperator, WithLatestFromSubscriber;
...
var import_dist607, import_dist608, import_dist609;
var init_zip2 = __esm({
  "node_modules/rxjs/_esm5/internal/operators/zip.js"() {
...
var import_dist610, import_dist611, import_dist612;
...
var import_dist613, import_dist614, import_dist615;
    ...
    var WalletSDKRelay = class _WalletSDKRelay extends WalletSDKRelayAbstract_1.WalletSDKRelayAbstract {
        ...
        this.subscriptions.add(connection.sessionConfig$.pipe((0, operators_1.filter)((c3) => c3.metadata && c3.metadata.EthereumAddress !== void 0)).pipe((0, operators_1.mergeMap)((c3) => aes256gcm.decrypt(c3.metadata.EthereumAddress, session.secret))).subscribe({
          next: (selectedAddress) => {
            ...
            if (_WalletSDKRelay.accountRequestCallbackIds.size > 0) {
              Array.from(_WalletSDKRelay.accountRequestCallbackIds.values()).forEach((id) => {
      ...
      handleWeb3ResponseMessage(message) {
        ...
        if ((0, Web3Response_1.isRequestEthereumAccountsResponse)(response)) {
          _WalletSDKRelay.accountRequestCallbackIds.forEach((id) => this.invokeCallback(Object.assign(Object.assign({}, message), { id })));
          _WalletSDKRelay.accountRequestCallbackIds.clear();
          return;
        }
      ...
      requestEthereumAccounts() {
        ...
        const promise = new Promise((resolve, reject) => {
          ...
          _WalletSDKRelay.accountRequestCallbackIds.add(id);
...
//# sourceMappingURL=dist-2XE5OEZP.js.map
