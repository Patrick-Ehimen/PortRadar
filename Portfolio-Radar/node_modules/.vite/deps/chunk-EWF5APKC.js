...
// node_modules/@thirdweb-dev/react/dist/paperWallet-3c5ea505.browser.esm.js
...
// node_modules/@thirdweb-dev/react/dist/oneKeyWallet-d991ab73.browser.esm.js
...
var ModelViewer = (0, import_react12.lazy)(() => import("./ModelViewer-ad6f3167.browser.esm-DEYCMU62.js"));
var PlayButton = (_ref) => {
  let {
    onClick,
    isPlaying
  ...
  (0, import_react12.useEffect)(() => {
    ...
    const preloadEmbeddedWallet = async () => {
      ...
      if (hasEmbeddedWallet && restProps.clientId) {
        const {
          EmbeddedWalletSdk
        } = await import("./thirdweb-dev-wallets.browser.esm-PHOKED4C.js");
...
function useInstalledWallets() {
  ...
  if (assertWindowEthereum(window_)) {
    ...
    isImTokenInstalled = !!((_c = window_.ethereum) == null ? void 0 : _c.isToken);
  }
  return {
...
function useRainbowWallet() {
  ...
  return (0, import_react12.useCallback)(async (connectOptions) => {
    const {
      rainbowWallet
    } = await import("./safeChainSlug-45b62b36.browser.esm-OS2GJQPW.js").then(function(n) {
      return n.R;
    });
...
function useFrameWallet() {
  ...
  return (0, import_react12.useCallback)(async (connectOptions) => {
    const {
      frameWallet
    } = await import("./frameWallet-63225c82.browser.esm-P3ZKWFAB.js");
...
function useBloctoWallet() {
  ...
  return (0, import_react12.useCallback)(async (options) => {
    const {
      bloctoWallet
    } = await import("./bloctoWallet-4cc043fb.browser.esm-TX46MKDL.js");
...
function usePaperWallet() {
  ...
  return (0, import_react12.useCallback)(async (options) => {
    ...
    } = await import("./paperWallet-3c5ea505.browser.esm-L76BF3YP.js");
...
function useWalletConnectV1() {
  ...
  return (0, import_react12.useCallback)(async (options) => {
    const {
      walletConnectV1
    } = await import("./walletConnectV1-9952746c.browser.esm-3UB7AHTX.js");
...
//# sourceMappingURL=chunk-EWF5APKC.js.map
