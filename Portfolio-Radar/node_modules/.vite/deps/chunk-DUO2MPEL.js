...
} from "./chunk-YBYD5VW5.js";
import {
  getInjectedRainbowProvider
} from "./chunk-ISY3KHJL.js";
import {
  AbstractWallet,
  ENTRYPOINT_ADDRESS,
  ERC6551_REGISTRY,
...
import {
  ...
  getChainProvider,
  isContractDeployed
} from "./chunk-B5EEBQGY.js";
import {
  require_utils
} from "./chunk-O2I64K6T.js";
import {
  c1,
  defaultChains,
  getValidChainRPCs,
  updateChainRPCs
} from "./chunk-JO5JQBLK.js";
import {
  eventemitter3_default
} from "./chunk-CQNLDQCU.js";
import {
  Wallet,
  ethers_exports,
  init_lib6 as init_lib3,
  utils_exports
} from "./chunk-4LOTL6ZJ.js";
import {
  init_lib4 as init_lib2,
  recoverAddress
} from "./chunk-PI5QRFQD.js";
import {
  require_events
...
function ut(r, t) {
  ...
  function f2(D3) {
    ...
    if (D3.length === 0)
      return "";
    for (var l2 = 0, m = 0, E2 = 0, y2 = D3.length; E2 !== y2 && D3[E2] === 0; )
      E2++, l2++;
    for (var w2 = (y2 - E2) * h2 + 1 >>> 0, g2 = new Uint8Array(w2); E2 !== y2; ) {
      for (var C2 = D3[E2], _3 = 0, b2 = w2 - 1; (C2 !== 0 || _3 < m) && b2 !== -1; b2--, _3++)
        C2 += 256 * g2[b2] >>> 0, g2[b2] = C2 % u >>> 0, C2 = C2 / u >>> 0;
      if (C2 !== 0)
        throw new Error("Non-zero carry");
      m = _3, E2++;
    }
    for (var v2 = w2 - m; v2 !== w2 && g2[v2] === 0; )
      v2++;
    for (var q2 = a.repeat(l2); v2 < w2; ++v2)
      q2 += r.charAt(g2[v2]);
    return q2;
  }
  function p2(D3) {
    ...
    if (D3[l2] !== " ") {
      ...
      if (D3[l2] !== " ") {
        for (var b2 = y2 - E2; b2 !== y2 && w2[b2] === 0; )
          b2++;
        for (var v2 = new Uint8Array(m + (y2 - b2)), q2 = m; b2 !== y2; )
          v2[q2++] = w2[b2++];
        return v2;
      }
    }
...
var qt2 = d({ prefix: "c", name: "base32pad", alphabet: "abcdefghijklmnopqrstuvwxyz234567=", bitsPerChar: 5 });
...
var Bt = Object.freeze({ __proto__: null, base32: Tt, base32upper: It, base32pad: qt2, base32padupper: Ut, base32hex: Ot, base32hexupper: St, base32hexpad: Pt, base32hexpadupper: Nt, base32z: $t });
...
var Kt2 = T({ name: "base58flickr", prefix: "Z", alphabet: "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ" });
var Vt = Object.freeze({ __proto__: null, base58btc: Lt, base58flickr: Kt2 });
...
var Br = class extends G {
  constructor(t) {
    super(t), this.initialized = false, this.name = "authEngine", this.init = () => {
      ...
      const D3 = await this.client.core.crypto.generateKeyPair(), l2 = Kn(D3);
      ...
      const m = await this.sendRequest(p2, "wc_authRequest", { payloadParams: { type: c ?? "eip4361", chainId: n, statement: s, aud: o2, domain: u, version: "1", nonce: a, iat: (/* @__PURE__ */ new Date()).toISOString(), exp: h2, nbf: f2 }, requester: { publicKey: D3, metadata: this.client.metadata } }, {}, e.expiry);
...
${e.resources.map((D3) => `- ${D3}`).join(`
`)}` : void 0;
      return [n, s, "", o2, "", u, a, c, h2, f2, p2, A2].filter((D3) => D3 != null).join(`
`);
...
`, JSON.stringify(a)), this.client.logger.debug("payload.iss:", u.iss), this.client.logger.debug("signature:", o2);
  ...
  registerRelayerEvents() {
    this.client.core.relayer.on(v.message, async (t) => {
...
var S = class _S extends H {
  constructor(t) {
    ...
    this.name = (t == null ? void 0 : t.name) || B, this.metadata = t.metadata, this.projectId = t.projectId, this.core = t.core || new kr(t), this.logger = (0, import_logger.generateChildLogger)(e, this.name), this.authKeys = new qt(this.core, this.logger, "authKeys", F, () => x), this.pairingTopics = new qt(this.core, this.logger, "pairingTopics", F), this.requests = new qt(this.core, this.logger, "requests", F, (i) => i.id), this.engine = new Br(this);
  }
  static async init(t) {
    const e = new _S(t);
...
o.prototype.getMaxListeners = function() {
  ...
  if (typeof u == "function")
    ...
    for (var v2 = u.length, T2 = b(u, v2), s = 0; s < v2; ++s)
      y(T2[s], this, e);
  return true;
};
function S2(n, t, e, s) {
...
function F2(n, t) {
  return new Promise(function(e, s) {
    ...
    R2(n, t, a, { once: true }), t !== "error" && D2(n, i, { once: true });
  });
}
function D2(n, t, e) {
...
var H2 = class extends q {
  constructor(t) {
    super(t), this.init = async () => {
      this.signClient = await ys.init({ core: this.client.core, metadata: this.client.metadata }), this.authClient = await zr.init({ core: this.client.core, projectId: "", metadata: this.client.metadata }), this.initializeEventListeners();
    }, this.pair = async (e) => {
...
var Q2 = { decryptMessage: async (n) => {
  const t = { core: new kr({ storageOptions: n.storageOptions, storage: n.storage }) };
  await t.core.crypto.init();
  const e = t.core.crypto.decode(n.topic, n.encryptedMessage);
  return t.core = null, e;
}, getMetadata: async (n) => {
  const t = { core: new kr({ storageOptions: n.storageOptions, storage: n.storage }), sessionStore: null };
...
// node_modules/@thirdweb-dev/wallets/dist/base-c6dcc39a.browser.esm.js
...
var BloctoWallet = class _BloctoWallet extends AbstractClientWallet {
  ...
  async initConnector() {
    ...
    const {
      BloctoConnector
    } = await import("./thirdweb-dev-wallets-evm-connectors-blocto.browser.esm-7IPDJJU3.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          MetaMaskConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-metamask.browser.esm-J6GMT3OO.js");
        ...
        } = await import("./thirdweb-dev-wallets-evm-connectors-wallet-connect.browser.esm-7EILGMN4.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          OKXConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-okx.browser.esm-V5PSUOMZ.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          CoreWalletConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-core-wallet.browser.esm-ZLL4WCSW.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          OneKeyConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-onekey.browser.esm-SOUZQ3MB.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        ...
        } = await import("./thirdweb-dev-wallets-evm-connectors-crypto-defi-wallet.browser.esm-GWVQT7CA.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          RabbyConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-rabby.browser.esm-UMRSIWU4.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          Coin98Connector
        } = await import("./thirdweb-dev-wallets-evm-connectors-coin98.browser.esm-E2RA3TNL.js");
...
var PaperWallet = class _PaperWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-paper.browser.esm-EZY2DRIZ.js");
...
var CoinbaseWallet = class _CoinbaseWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-coinbase-wallet.browser.esm-FID7HARY.js");
...
var EmbeddedWallet = class _EmbeddedWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-embedded-wallet.browser.esm-6OZ46QRQ.js");
...
var FrameWallet = class _FrameWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        FrameConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-frame.browser.esm-AX2AODKP.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          ImTokenConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-imtoken.browser.esm-RWNAEDHK.js");
...
var InjectedWallet = class _InjectedWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        InjectedConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-injected.browser.esm-2PYL6MQB.js");
...
var LocalWallet = class _LocalWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-local-wallet.browser.esm-4PXRXETB.js");
...
var SignerWallet = class extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SignerConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-signer.browser.esm-XDUIQQUG.js");
      if (!this.signer) {
...
var MagicLink = class _MagicLink extends AbstractClientWallet {
  ...
  async initializeConnector() {
    const {
      MagicAuthConnector
    } = await import("./thirdweb-dev-wallets-evm-connectors-magic.browser.esm-A26BVGC4.js");
...
var XDEFIWallet = class _XDEFIWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        XDEFIConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-xdefi.browser.esm-GHAMTSE7.js");
...
var PhantomWallet = class _PhantomWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        PhantomConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-phantom.browser.esm-P5QJVWWD.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          RainbowConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-rainbow.browser.esm-5XSJTJHW.js");
...
var SafeWallet = class _SafeWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        SafeConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-safe.browser.esm-7A7CTMAG.js");
...
var SmartWallet = class _SmartWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-smart-wallet.browser.esm-LO3PQZJW.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          TrustConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-trust.browser.esm-OU6TBJZR.js");
  ...
  async getConnector() {
    ...
    if (!this.connector) {
      if (this.isInjected) {
        const {
          ZerionConnector
        } = await import("./thirdweb-dev-wallets-evm-connectors-zerion.browser.esm-4WHSDNVV.js");
...
var TokenBoundSmartWallet = class extends SmartWallet {
  ...
  async getConnector() {
    if (!this.tbaConnector) {
      ...
      } = await import("./thirdweb-dev-wallets-evm-connectors-token-bound-smart-wallet.browser.esm-2DIOW5GB.js");
...
var MagicEdenWallet = class _MagicEdenWallet extends AbstractClientWallet {
  ...
  async getConnector() {
    if (!this.connector) {
      const {
        MagicEdenConnector
      } = await import("./thirdweb-dev-wallets-evm-connectors-magic-eden.browser.esm-AVEGXV7E.js");
...
//# sourceMappingURL=chunk-DUO2MPEL.js.map
