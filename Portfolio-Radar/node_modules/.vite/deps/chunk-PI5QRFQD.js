...
var import_dist4, import_dist5, import_dist6, __awaiter, logger, allowedTransactionKeys, forwardErrors, Signer, VoidSigner;
...
var init_version2 = __esm({
  "node_modules/@ethersproject/abstract-provider/lib.esm/_version.js"() {
    ...
    version2 = "abstract-provider/5.7.0";
  }
});
...
var import_dist10, import_dist11, import_dist12, __awaiter2, logger2, ForkEvent, BlockForkEvent, TransactionForkEvent, TransactionOrderForkEvent, Provider;
var init_lib14 = __esm({
  "node_modules/@ethersproject/abstract-provider/lib.esm/index.js"() {
    ...
    TransactionForkEvent = class extends ForkEvent {
      constructor(hash2, expiry) {
        if (!isHexString(hash2, 32)) {
          logger2.throwArgumentError("invalid transaction hash", "hash", hash2);
        }
        super({
          _isForkEvent: true,
...
var import_dist16, import_dist17, import_dist18, logger3, homestead, ropsten, classicMordor, networks;
...
var import_dist19, import_dist20, import_dist21, BaseX, Base32, Base58;
...
var import_dist25, import_dist26, import_dist27, __awaiter3;
...
var import_dist28, import_dist29, import_dist30, __awaiter4, logger4;
...
var import_dist34, import_dist35, import_dist36, import_bn, import_hash, minimalisticAssert, utils_1, utils_1$1, getNAF, getJSF, assert$1, base, inherits_browser, assert$2, short_1, curve_1, curves_1, hmacDrbg, assert$3, key, assert$4, signature, rand, assert$5, ec, elliptic_1, EC$1;
...
var import_dist37, import_dist38, import_dist39, version6;
...
var import_dist40, import_dist41, import_dist42, logger5, _curve, SigningKey;
...
var import_dist43, import_dist44, import_dist45, version7;
...
function _serialize(transaction, signature2) {
  ...
  if (chainId !== 0) {
    ...
    v += chainId * 2 + 8;
    if (sig.v > 28 && sig.v !== v) {
      logger6.throwArgumentError("transaction.chainId/signature.v mismatch", "signature", signature2);
    }
  } else if (sig.v !== v) {
    logger6.throwArgumentError("transaction.chainId/signature.v mismatch", "signature", signature2);
  }
...
function serialize(transaction, signature2) {
  ...
  return logger6.throwError(`unsupported transaction type: ${transaction.type}`, Logger.errors.UNSUPPORTED_OPERATION, {
...
function _parseEip1559(payload) {
  ...
  if (transaction.length !== 9 && transaction.length !== 12) {
    logger6.throwArgumentError("invalid component count for transaction type: 2", "payload", hexlify(payload));
  }
...
function _parseEip2930(payload) {
  ...
  if (transaction.length !== 8 && transaction.length !== 11) {
    logger6.throwArgumentError("invalid component count for transaction type: 1", "payload", hexlify(payload));
  }
  const tx = {
    type: 1,
    chainId: handleNumber(transaction[0]).toNumber(),
...
function parse(rawTransaction) {
  ...
  return logger6.throwError(`unsupported transaction type: ${payload[0]}`, Logger.errors.UNSUPPORTED_OPERATION, {
    operation: "parseTransaction",
    transactionType: payload[0]
  });
}
var import_dist46, import_dist47, import_dist48, logger6, TransactionTypes, transactionFields, allowedTransactionKeys2;
...
var import_dist49, import_dist50, import_dist51, logger7, Formatter, throttleMessage;
...
var import_dist52, import_dist53, import_dist54, import_bech32, __awaiter5, logger8, MAX_CCIP_REDIRECTS, PollableEvents, Event, coinInfos, matcherIpfs, matchers, Resolver, defaultFormatter, nextPollId, BaseProvider;
    ...
    Resolver = class {
      ...
      _getAddress(coinType, hexBytes) {
        ...
        if (coinInfo.prefix != null) {
          ...
          if (version9 >= 0 && bytes.length === 2 + length && length >= 1 && length <= 75) {
            const words = import_bech32.default.toWords(bytes.slice(2));
            words.unshift(version9);
...
var import_dist55, import_dist56, import_dist57, __awaiter6, logger9, errorGas, _constructorGuard, JsonRpcSigner, UncheckedJsonRpcSigner, allowedTransactionKeys3, JsonRpcProvider;
...
var import_dist58, import_dist59, import_dist60, WS;
var init_ws = __esm({
  "node_modules/@ethersproject/providers/lib.esm/ws.js"() {
    "use strict";
    ...
    try {
      ...
      WS = function() {
        logger23.throwError("WebSockets not supported in this environment", Logger.errors.UNSUPPORTED_OPERATION, {
...
var import_dist61, import_dist62, import_dist63, __awaiter7, logger10, NextId, WebSocketProvider;
var init_websocket_provider = __esm({
  "node_modules/@ethersproject/providers/lib.esm/websocket-provider.js"() {
    ...
    WebSocketProvider = class extends JsonRpcProvider {
      constructor(url, network) {
        if (network === "any") {
          logger10.throwError("WebSocketProvider does not support 'any' network yet", Logger.errors.UNSUPPORTED_OPERATION, {
      ...
      resetEventsBlock(blockNumber) {
        logger10.throwError("cannot reset events block on WebSocketProvider", Logger.errors.UNSUPPORTED_OPERATION, {
          operation: "resetEventBlock"
        });
      }
      set pollingInterval(value) {
        logger10.throwError("cannot set polling interval on WebSocketProvider", Logger.errors.UNSUPPORTED_OPERATION, {
      ...
      set polling(value) {
        ...
        logger10.throwError("cannot set polling on WebSocketProvider", Logger.errors.UNSUPPORTED_OPERATION, {
...
var import_dist64, import_dist65, import_dist66, __awaiter8, logger11, StaticJsonRpcProvider, UrlJsonRpcProvider;
  ...
  "node_modules/@ethersproject/providers/lib.esm/url-json-rpc-provider.js"() {
      ...
      detectNetwork() {
        ...
        return __awaiter8(this, void 0, void 0, function* () {
          ...
          if (network == null) {
            ...
            if (!network) {
              logger11.throwError("no network detected", Logger.errors.UNKNOWN_ERROR, {});
            }
            if (this._network == null) {
              defineReadOnly(this, "_network", network);
              this.emit("network", network, null);
    ...
    UrlJsonRpcProvider = class _UrlJsonRpcProvider extends StaticJsonRpcProvider {
      constructor(network, apiKey) {
        logger11.checkAbstract(new.target, _UrlJsonRpcProvider);
      ...
      _startPending() {
        logger11.warn("WARNING: API provider does not support pending filters");
      }
      isCommunityResource() {
        return false;
      }
      getSigner(address) {
        return logger11.throwError("API provider does not support signing", Logger.errors.UNSUPPORTED_OPERATION, { operation: "getSigner" });
      }
      listAccounts() {
      ...
      static getUrl(network, apiKey) {
        return logger11.throwError("not implemented; sub-classes must override getUrl", Logger.errors.NOT_IMPLEMENTED, {
          operation: "getUrl"
        });
      }
    };
...
var import_dist67, import_dist68, import_dist69, logger12, defaultApiKey, AlchemyWebSocketProvider, AlchemyProvider;
...
var import_dist70, import_dist71, import_dist72, logger13, defaultApiKey2, AnkrProvider;
...
var import_dist73, import_dist74, import_dist75, __awaiter9, logger14, CloudflareProvider;
...
var import_dist76, import_dist77, import_dist78, __awaiter10, logger15, EtherscanProvider;
...
var import_dist79, import_dist80, import_dist81, version8;
...
var import_dist82, import_dist83, import_dist84, logger16, anyGlobal, crypto;
...
var import_dist91, import_dist92, import_dist93, __awaiter11, logger17, nextRid, ForwardErrors, ForwardProperties, FallbackProvider;
...
var import_dist94, import_dist95, import_dist96, IpcProvider;
...
var import_dist97, import_dist98, import_dist99, logger18, defaultProjectId, InfuraWebSocketProvider, InfuraProvider;
...
var import_dist100, import_dist101, import_dist102, JsonRpcBatchProvider;
...
var import_dist103, import_dist104, import_dist105, logger19, defaultApiKey3, NodesmithProvider;
...
var import_dist106, import_dist107, import_dist108, logger20, defaultApplicationId, PocketProvider;
...
var import_dist109, import_dist110, import_dist111, logger21, _nextId, Web3Provider;
...
var import_dist112, import_dist113, import_dist114, logger22;
...
export {
  ...
  serialize,
  parse,
  lib_exports6 as lib_exports4,
  init_lib19 as init_lib4,
  Base58,
  ...
  init_lib20 as init_lib6,
  _fetchData,
  fetchJson,
  poll,
  lib_exports4 as lib_exports7,
  init_lib17 as init_lib7,
  getDefaultProvider,
  lib_exports9 as lib_exports8,
  init_lib21 as init_lib8
};
//# sourceMappingURL=chunk-PI5QRFQD.js.map
